                ...
                <div className="container lg:px-0">
                    <div className="flex items-center justify-between">
                        ...
                        <nav className="hidden md:flex text-black/60 gap-6 items-center">
                            ...
                            <a href="#">Help</a>
                            <button className="bg-black text-white px-4 py-2 rounded-lg font font-medium inline-flex align-items justify-center  tracking-tight" onClick={}>connect wallet</button>
                        </nav>
